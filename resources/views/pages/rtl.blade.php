...
<head>
    ...
    <link href="{{ asset('public/black') }}/demo/demo.css" rel="stylesheet" />
</head>
...
<body class=" rtl menu-on-right ">
            ...
            <ul class="navbar-nav  mr-auto">
              ...
              <li class="dropdown nav-item">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                  <div class="photo">
                    <img src="{{ asset('public/black') }}/img/anime3.png" alt="Profile Photo">
                  </div>
  ...
  <script src="{{ asset('public/black') }}/demo/demo.js"></script>
  <script>
